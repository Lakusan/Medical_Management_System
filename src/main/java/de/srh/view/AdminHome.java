...
public class AdminHome extends JFrame {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Accounts permission");
    ...
    private void jButton24ActionPerformed(java.awt.event.ActionEvent evt) {
        AdminAccountsPermission adminAccountsPermission = new AdminAccountsPermission();
        this.toBack();
        this.setVisible(false);
        adminAccountsPermission.toFront();
        adminAccountsPermission.setLocationRelativeTo(null);
        adminAccountsPermission.setState(java.awt.Frame.NORMAL);
        adminAccountsPermission.setVisible(true);
    }
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {
        AdminImportantNotices adminImportantNotices = new AdminImportantNotices();
        this.toBack();
        this.setVisible(false);
        adminImportantNotices.toFront();
        adminImportantNotices.setVisible(true);
        adminImportantNotices.setLocationRelativeTo(null);
        adminImportantNotices.setState(java.awt.Frame.NORMAL);
    }
